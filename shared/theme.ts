...
export const THEME_VALIDATION_MATRIX: readonly ThemeMatrixEntry[] = [
  ...
  normalText("accent", "canvas"),
  normalText("accent", "paper"),
  normalText("accentStrong", "canvas"),
  normalText("accentStrong", "paper"),
  normalText("onAccent", "accent"),
  normalText("onAccent", "accentStrong"),
  normalText("success", "canvas"),
  normalText("success", "paper"),
  normalText("success", "successSoft"),
  normalText("warning", "canvas"),
  normalText("warning", "paper"),
  ...
  ...(
    ...
    normalText(role, "paper"),
    normalText(role, "added"),
    normalText(role, "addedStrong"),
    normalText(role, "removed"),
    normalText(role, "removedStrong"),
  ]),
];
